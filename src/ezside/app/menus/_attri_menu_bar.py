"""The _AttriMenuBar provides a mixin class inheriting from QMenuBar with the
class body from AttriClass. """
#  GPL-3.0 license
...
class _AttriMenuBar(QMenuBar):
  """The _AttriBar provides a mixin class inheriting from QMenuBar with the
  class body from AttriClass. """
