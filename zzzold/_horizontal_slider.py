...
class HorizontalSlider(CanvasWidget):
  ...
  def sliderValue(self) -> float:
    """Exposes the unit ranged value of the slider"""
    return self._getHandlePosition()
