...
from ezside.core import AlignHCenter, AlignVCenter, parseBrush, AlignFlag
from ezside.core import SolidLine, SolidFill, parsePen
...
class SevenSegmentDigit(CanvasWidget):
  ...
  def getFallbackSettings(cls) -> dict[str, Any]:
    ...
    canvasWidgetStyles = CanvasWidget.getFallbackSettings()
    SevenSegmentDigitStyles = {
      'highBrush'      : highBrush,
      'lowBrush'       : lowBrush,
      'highPen'        : highPen,
