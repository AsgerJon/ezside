"""The _AttriStatusBar provides a mixin class inheriting from QStatusBar
with the class body from AttriClass. """
#  GPL-3.0 license
...
class _AttriStatusBar(QStatusBar):
  """The _AttriStatusBar provides a mixin class inheriting from QMenuBar
  with the class body from AttriClass. """
